      ...
      <div className="bg-stone-100">
        ...
        <div className="bg-gray-100 py-10 px-4">
          ...
          <div className="overflow-x-hidden">
            <div className="whitespace-nowrap animate-scroll group">
              {/* Reviews */}
              <div className="inline-block">
                {reviews.map((review, index) => (
                    <div
                        key={index}
                        className="inline-block bg-white p-6 shadow-lg rounded-lg mx-4 mb-4 w-72 h-auto transform transition-all duration-300 hover:scale-105 hover:h-auto"
                    >
                      ...
                      {/* Review Text */}
                      <p className="text-gray-700 truncate group-hover:whitespace-normal group-hover:overflow-visible">
                        {review.review}
                      </p>
                    </div>
                ))}
          ...
          <style jsx>{`
            ...
            /* Truncate review text by default and show full text on hover */
            .truncate {
              overflow: hidden;
            ...
            .group-hover\\:overflow-visible:hover {
              overflow: visible;
            }
          `}</style>
        </div>
